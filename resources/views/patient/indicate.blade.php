...
@section('content')
    <div class="container-fluid pb-3">
        ...
        <div class="row">
            ...
            <h5><span class="text-bold">Indicações realizadas:</span> 0</h5>
            <h5><span class="text-bold">Descontos concebidos:</span> R$ 0,00</h5>
            <h5><span class="text-bold">Descontos a receber:</span> R$ 0,00</h5>

            <p>Quem indica amigo é!</p>
            <p>Ao indicar um amigo você ganha 20% de desconto na sua próxima mensalidade.</p>
            <p>Para participar é simples:</p>
            ...
            <!-- O que acha de ter um código para o amigo informar na clínica? -->
            <p>3) Você será notificado pelo app que ganhou o desconto, caso o seu amigo inicie o tratamento ortodôntico conosco.</p>
